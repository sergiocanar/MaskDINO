...
"""
    ...
    for img_dict, anno_dict_list in tqdm(imgs_anns):
        ...
        record["dataset"] = img_dict.get("dataset", dataset_name)
        ...
        for anno in anno_dict_list:
            ...
            if segm:  # either list[list[float]] or dict(RLE)
                if isinstance(segm, dict):
                    ...
                    #         poly_segm.append(segmentation)
                    #     segm = [poly for poly in poly_segm if len(poly) % 2 == 0 and len(poly) >= 6]
                else:
...
def register_coco_instances(name, metadata, json_file, image_root):
    ...
    # TODO: You can change the evaluator_type to "coco" if you want to use COCO evaluation.
